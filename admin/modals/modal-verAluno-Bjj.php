<!-- Modal Alunos BJJ-->
              ...
              <div class="modal fade" id="verBjj" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" >
                          ...
                          <div class="modal-body">
                              ...
                              <div class="card mb-3">
                                  <div class="card-header">
                                      <i class="fa fa-table"></i> Tabela de Registros de Alunos do Jiu-Jitsu</div>
                                  <div class="card-body">
